      ...
      <div className="dc-inner">
        ...
        <RevealStagger className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mb-12 lg:grid-cols-4 lg:gap-5">
          {packageCategories.map((cat) => (
            ...
            <Link
              to={`/pricing#${cat.id}`}
              className="group flex flex-col rounded-dc border border-dc-border-soft bg-dc-surface/70 p-6 shadow-sm transition-[border-color,background-color,box-shadow] duration-300 ease-out hover:border-dc-sage/45 hover:bg-white hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dc-lime"
            >
        ...
        <Reveal>
        <div className="flex flex-col items-center justify-between gap-6 rounded-dc-lg border border-dc-border-soft bg-dc-surface px-6 py-8 sm:flex-row sm:px-8 lg:px-10">
          <div>
            ...
            <a
              ...
              className="mt-3 inline-block text-[18px] font-normal text-dc-sage-dark hover:text-dc-ink"
            >
          ...
          <Link
            to="/pricing"
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full bg-dc-ink px-7 py-3.5 text-[15px] font-normal text-white shadow-md transition-colors hover:bg-dc-charcoal-soft focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dc-lime"
          >
            Full package list
          </Link>
        </div>
